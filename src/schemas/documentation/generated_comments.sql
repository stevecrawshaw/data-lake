...
-- Table: iod2025_tbl
COMMENT ON TABLE mca_env_base.iod2025_tbl IS 'Table containing 56 columns';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.lsoa_cd IS 'Lsoa code';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.lsoa_nm IS 'Lsoa name';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.la_cd IS 'La code';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.la_nm IS 'La name';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.imd_score IS 'Imd score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.imd_rank IS 'Imd rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.imd_decile IS 'Imd decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.income_score IS 'Income score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.income_rank IS 'Income rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.income_decile IS 'Income decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.employment_score IS 'Employment score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.employment_rank IS 'Employment rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.employment_decile IS 'Employment decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.education_score IS 'Education score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.education_rank IS 'Education rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.education_decile IS 'Education decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.health_score IS 'Health score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.health_rank IS 'Health rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.health_decile IS 'Health decile (where 1 is most deprived 10%)';
...
COMMENT ON COLUMN mca_env_base.iod2025_tbl.crime_decile IS 'Crime decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.barriers_score IS 'Barriers score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.barriers_rank IS 'Barriers rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.barriers_decile IS 'Barriers decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.living_env_score IS 'Living env score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.living_env_rank IS 'Living env rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.living_env_decile IS 'Living env decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaci_score IS 'Idaci score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaci_rank IS 'Idaci rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaci_decile IS 'Idaci decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaopi_score IS 'Idaopi score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaopi_rank IS 'Idaopi rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaopi_decile IS 'Idaopi decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.cyp_sub_score IS 'Cyp sub score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.cyp_sub_rank IS 'Cyp sub rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.cyp_sub_decile IS 'Cyp sub decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.adult_skills_sub_score IS 'Adult skills sub score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.adult_skills_sub_rank IS 'Adult skills sub rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.adult_skills_sub_decile IS 'Adult skills sub decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.geo_barriers_sub_score IS 'Geo barriers sub score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.geo_barriers_sub_rank IS 'Geo barriers sub rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.geo_barriers_sub_decile IS 'Geo barriers sub decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.wider_barriers_sub_score IS 'Wider barriers sub score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.wider_barriers_sub_rank IS 'Wider barriers sub rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.wider_barriers_sub_decile IS 'Wider barriers sub decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.indoors_sub_score IS 'Indoors sub score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.indoors_sub_rank IS 'Indoors sub rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.indoors_sub_decile IS 'Indoors sub decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.outdoors_sub_score IS 'Outdoors sub score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.outdoors_sub_rank IS 'Outdoors sub rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.outdoors_sub_decile IS 'Outdoors sub decile (where 1 is most deprived 10%)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.total_pop IS 'Total population count';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.children_pop IS 'Children population count';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.older_pop IS 'Older population count';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.working_age_pop IS 'Working age population count';
...
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LMK_KEY IS 'Individual lodgement identifier. Guaranteed to be unique and can be used to identify a certificate in the downloads and the API.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.BUILDING_REFERENCE_NUMBER IS 'Unique identifier for the property.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CURRENT_ENERGY_RATING IS 'Current energy rating converted into a linear ''A to G'' rating (where A is the most energy efficient and G is the least energy efficient)';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.POTENTIAL_ENERGY_RATING IS 'Estimated potential energy rating converted into a linear ''A to G'' rating (where A is the most energy efficient and G is the least energy efficient)';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CURRENT_ENERGY_EFFICIENCY IS 'Based on cost of energy, i.e. energy required for space heating, water heating and lighting [in kWh/year] multiplied by fuel costs. (£/m²/year where cost is derived from kWh).';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.POTENTIAL_ENERGY_EFFICIENCY IS 'The potential energy efficiency rating of the property.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.PROPERTY_TYPE IS 'Describes the type of property such as House, Flat, Maisonette etc. This is the type differentiator for dwellings.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.BUILT_FORM IS 'The building type of the Property e.g. Detached, Semi-Detached, Terrace etc. Together with the Property Type, the Build Form produces a structured description of the property';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.INSPECTION_DATE IS 'The date that the inspection was actually carried out by the energy assessor';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LOCAL_AUTHORITY IS 'Office for National Statistics (ONS) code. Local authority area in which the building is located.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CONSTITUENCY IS 'Office for National Statistics (ONS) code. Parliamentary constituency in which the building is located.';
...
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CO2_EMISS_CURR_PER_FLOOR_AREA IS 'CO₂ emissions per square metre floor area per year in kg/m²';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CO2_EMISSIONS_POTENTIAL IS 'Estimated value in Tonnes per Year of the total CO₂ emissions produced by the Property in 12 month period.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LIGHTING_COST_CURRENT IS 'GBP. Current estimated annual energy costs for lighting the property.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LIGHTING_COST_POTENTIAL IS 'GBP. Potential estimated annual energy costs for lighting the property after improvements have been made.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HEATING_COST_CURRENT IS 'GBP. Current estimated annual energy costs for heating the property.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HEATING_COST_POTENTIAL IS 'GBP. Potential annual energy costs for lighting the property after improvements have been made.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HOT_WATER_COST_CURRENT IS 'GBP. Current estimated annual energy costs for hot water';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HOT_WATER_COST_POTENTIAL IS 'GBP. Potential estimated annual energy costs for hot water after improvements have been made.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.TOTAL_FLOOR_AREA IS 'The total useful floor area is the total of all enclosed spaces measured to the internal face of the external walls, i.e. the gross floor area as measured in accordance with the guidance issued from time to time by the Royal Institute of Chartered Surveyors or by a body replacing that institution. (m²)';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.ENERGY_TARIFF IS 'Type of electricity tariff for the property, e.g. single.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINS_GAS_FLAG IS 'Whether mains gas is available. Yes means that there is a gas meter or a gas-burning appliance in the dwelling. A closed-off gas pipe does not count.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLOOR_LEVEL IS 'Flats and maisonettes only. Floor level relative to the lowest level of the property (0 for ground floor). If there is a basement, the basement is level 0 and the other floors are from 1 upwards';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLAT_TOP_STOREY IS 'Whether the flat is on the top storey';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLAT_STOREY_COUNT IS 'The number of storeys in the apartment block.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAIN_HEATING_CONTROLS IS 'Type of main heating controls. Includes both main heating systems if there are two.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MULTI_GLAZE_PROPORTION IS 'The estimated banded range (e.g. 0% - 10%) of the total glazed area of the Property that is multiple glazed.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.GLAZED_TYPE IS 'The type of glazing. From British Fenestration Rating Council or manufacturer declaration, one of; single; double; triple.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.GLAZED_AREA IS 'Ranged estimate of the total glazed area of the Habitable Area.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.EXTENSION_COUNT IS 'The number of extensions added to the property. Between 0 and 4.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.NUMBER_HABITABLE_ROOMS IS 'Habitable rooms include any living room, sitting room, dining room, bedroom, study and similar; and also a non-separated conservatory. A kitchen/diner having a discrete seating area (with space for a table and four chairs) also counts as a habitable room. A non-separated conservatory adds to the habitable room count if it has an internal quality door between it and the dwelling. Excluded from the room count are any room used solely as a kitchen, utility room, bathroom, cloakroom, en-suite accommodation and similar and any hallway, stairs or landing; and also any room not having a window.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.NUMBER_HEATED_ROOMS IS 'The number of heated rooms in the property if more than half of the habitable rooms are not heated.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LOW_ENERGY_LIGHTING IS 'The percentage of low energy lighting present in the property as a percentage of the total fixed lights in the property. 0% indicates that no low-energy lighting is present.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.NUMBER_OPEN_FIREPLACES IS 'The number of Open Fireplaces in the Property. An Open Fireplace is a fireplace that still allows air to pass between the inside of the Property and the outside.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HOTWATER_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HOT_WATER_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HOT_WATER_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLOOR_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLOOR_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLOOR_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WINDOWS_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WINDOWS_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WINDOWS_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WALLS_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WALLS_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WALLS_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.SECONDHEAT_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.SHEATING_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.SHEATING_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.ROOF_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.ROOF_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.ROOF_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINHEAT_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINHEAT_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINHEAT_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINHEATCONT_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINHEATC_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAINHEATC_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LIGHTING_DESCRIPTION IS 'Overall description of the property feature';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LIGHTING_ENERGY_EFF IS 'Energy efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LIGHTING_ENV_EFF IS 'Environmental efficiency rating. One of: very good; good; average; poor; very poor. On actual energy certificate shown as one to five star rating.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MAIN_FUEL IS 'The type of fuel used to power the central heating e.g. Gas, Electricity';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.WIND_TURBINE_COUNT IS 'Number of wind turbines; 0 if none.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.HEAT_LOSS_CORRIDOR IS 'Flats and maisonettes only. Indicates that the flat contains a corridor through which heat is lost. Heat loss corridor, one of: no corridor; heated corridor; unheated corridor';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.UNHEATED_CORRIDOR_LENGTH IS 'The total length of unheated corridor in the flat. Only populated if flat or maisonette contains unheated corridor. If unheated corridor, length of sheltered wall (m²).';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FLOOR_HEIGHT IS 'Average height of the storey in metres.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.PHOTO_SUPPLY IS 'Percentage of photovoltaic area as a percentage of total roof area. 0% indicates that a Photovoltaic Supply is not present in the property.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.SOLAR_WATER_HEATING_FLAG IS 'Indicates whether the heating in the Property is solar powered.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.MECHANICAL_VENTILATION IS 'Identifies the type of mechanical ventilation the property has. This is required for the RdSAP calculation.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LOCAL_AUTHORITY_LABEL IS 'The name of the local authority area in which the building is located. This field is for additional information only and should not be relied upon: please refer to the Local Authority ONS Code.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CONSTITUENCY_LABEL IS 'The name of the parliamentary constituency in which the building is located. This field is for additional information only and should not be relied upon: please refer to the Constituency ONS Code.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.POSTTOWN IS 'The post town of the property';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.CONSTRUCTION_AGE_BAND IS 'Age band when building part constructed. England & Wales only. One of: before 1900; 1900-1929; 1930-1949; 1950-1966; 1967-1975; 1976-1982; 1983-1990; 1991-1995; 1996-2002; 2003-2006; 2007-2011; 2012 onwards.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LODGEMENT_DATETIME IS 'Date and time lodged on the Energy Performance of Buildings Register.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.TENURE IS 'Describes the tenure type of the property. One of: Owner-occupied; Rented (social); Rented (private).';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.FIXED_LIGHTING_OUTLETS_COUNT IS 'The number of fixed lighting outlets.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.LOW_ENERGY_FIXED_LIGHT_COUNT IS 'The number of low-energy fixed lighting outlets.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.UPRN IS 'The UPRN submitted by an assessor or alternatively from the department’s address matching algorithm.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.UPRN_SOURCE IS 'Populated with the values "Energy Assessor" or "Address Matched" to show how the UPRN was populated.';
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.REPORT_TYPE IS 'Type of assessment carried out on the building, for domestic dwellings this is either a SAP (Standard Assessment Procedure) or a Reduced SAP. 100: RdSAP (Reduced SAP for existing buildings) and 101: SAP (full Sap for new dwellings, including conversions and change of use). This variable will help distinguish between new and existing dwellings.';
