...
-- Table: iod2025_tbl
COMMENT ON TABLE mca_env_base.iod2025_tbl IS 'Index of Deprivation (IoD) 2025 File 7 - all ranks, scores, deciles, and population denominators by LSOA (England)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.lsoa_cd IS 'LSOA code (2021)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.lsoa_nm IS 'LSOA name (2021)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.la_cd IS 'Local Authority District code (2024)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.la_nm IS 'Local Authority District name (2024)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.imd_score IS 'Index of Multiple Deprivation (IMD) Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.imd_rank IS 'Index of Multiple Deprivation (IMD) Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.imd_decile IS 'Index of Multiple Deprivation (IMD) Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.income_score IS 'Income Score (rate)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.income_rank IS 'Income Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.income_decile IS 'Income Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.employment_score IS 'Employment Score (rate)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.employment_rank IS 'Employment Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.employment_decile IS 'Employment Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.education_score IS 'Education, Skills and Training Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.education_rank IS 'Education, Skills and Training Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.education_decile IS 'Education, Skills and Training Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.health_score IS 'Health Deprivation and Disability Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.health_rank IS 'Health Deprivation and Disability Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.health_decile IS 'Health Deprivation and Disability Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.crime_score IS 'Crime Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.crime_rank IS 'Crime Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.crime_decile IS 'Crime Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.barriers_score IS 'Barriers to Housing and Services Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.barriers_rank IS 'Barriers to Housing and Services Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.barriers_decile IS 'Barriers to Housing and Services Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.living_env_score IS 'Living Environment Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.living_env_rank IS 'Living Environment Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.living_env_decile IS 'Living Environment Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaci_score IS 'Income Deprivation Affecting Children Index (IDACI) Score (rate)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaci_rank IS 'Income Deprivation Affecting Children Index (IDACI) Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaci_decile IS 'Income Deprivation Affecting Children Index (IDACI) Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaopi_score IS 'Income Deprivation Affecting Older People (IDAOPI) Score (rate)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaopi_rank IS 'Income Deprivation Affecting Older People (IDAOPI) Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.idaopi_decile IS 'Income Deprivation Affecting Older People (IDAOPI) Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.cyp_sub_score IS 'Children and Young People Sub-domain Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.cyp_sub_rank IS 'Children and Young People Sub-domain Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.cyp_sub_decile IS 'Children and Young People Sub-domain Decile (where 1 is most deprived 10% of LSO';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.adult_skills_sub_score IS 'Adult Skills Sub-domain Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.adult_skills_sub_rank IS 'Adult Skills Sub-domain Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.adult_skills_sub_decile IS 'Adult Skills Sub-domain Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.geo_barriers_sub_score IS 'Geographical Barriers Sub-domain Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.geo_barriers_sub_rank IS 'Geographical Barriers Sub-domain Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.geo_barriers_sub_decile IS 'Geographical Barriers Sub-domain Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.wider_barriers_sub_score IS 'Wider Barriers Sub-domain Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.wider_barriers_sub_rank IS 'Wider Barriers Sub-domain Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.wider_barriers_sub_decile IS 'Wider Barriers Sub-domain Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.indoors_sub_score IS 'Indoors Sub-domain Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.indoors_sub_rank IS 'Indoors Sub-domain Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.indoors_sub_decile IS 'Indoors Sub-domain Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.outdoors_sub_score IS 'Outdoors Sub-domain Score';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.outdoors_sub_rank IS 'Outdoors Sub-domain Rank (where 1 is most deprived)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.outdoors_sub_decile IS 'Outdoors Sub-domain Decile (where 1 is most deprived 10% of LSOAs)';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.total_pop IS 'Total population: mid 2022';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.children_pop IS 'Dependent Children aged 0-15: mid 2022';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.older_pop IS 'Older population aged 60 and over: mid 2022';
COMMENT ON COLUMN mca_env_base.iod2025_tbl.working_age_pop IS 'Working age population 18-66 (for use with Employment Deprivation Domain): mid 2022';
...
COMMENT ON TABLE mca_env_base.ca_boundaries_inc_ns_vw IS 'Combined Authority boundaries including North Somerset';
...
COMMENT ON TABLE mca_env_base.ca_la_lookup_inc_ns_vw IS 'Combined Authority to Local Authority lookup including North Somerset';
...
COMMENT ON TABLE mca_env_base.weca_lep_la_vw IS 'West of England LEP Local Authorities lookup';
...
COMMENT ON COLUMN mca_env_base.ca_la_ghg_emissions_sub_sector_ods_vw.cauthcd IS 'Combined Authority code (ONS)';
COMMENT ON COLUMN mca_env_base.ca_la_ghg_emissions_sub_sector_ods_vw.cauthnm IS 'Combined Authority name';
