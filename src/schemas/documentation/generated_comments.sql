...
COMMENT ON COLUMN mca_env_base.epc_domestic_lep_vw.ADDRESS IS 'Field containing the concatenation of address1, address2 and address3. Note that post code is recorded separately.';
